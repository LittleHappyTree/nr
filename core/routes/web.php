...
Route::get('/.well-known/pki-validation/fileauth.txt', function(){
    return '8cnw03x686xbtnyrtpj3057lyfdvvtx7';
});

Route::get('ganti-bahasa/{bahasa}','Nebros\Bahsa_controller@index');
// ***************** Template Nebro *****************
// Route::group(['middleware' => 'setlang'], function() {
    // App::setLocale('id');
    Route::group(['middleware'=>'visitor'],function(){
        Route::get('/','Nebros\Beranda_controller@index');

        // profile perusahaan
        Route::get('/profile-perusahaan','Nebros\Profile_perusahaan_controller@index');

        // visi misi
        Route::get('/visi-misi','Nebros\Profile_perusahaan_controller@visi_misi');

        // maksud dan tujuan
        Route::get('/maksud-tujuan','Nebros\Profile_perusahaan_controller@maksud_tujuan');

        // dewan komisaris
        Route::get('/dewan-komisaris','Nebros\Profile_perusahaan_controller@dewan_komisaris');

        // dewan pengawas syariah
        Route::get('/dewan-pengawas-syariah','Nebros\Profile_perusahaan_controller@dewan_pengawas_syariah');

        // direksi
        Route::get('/direksi','Nebros\Profile_perusahaan_controller@direksi');

        // produk reasuransi umum
        Route::get('/reasum','Nebros\Profile_perusahaan_controller@produk_reasum');

        // produk reasuransi jiwa
        Route::get('/reasji','Nebros\Profile_perusahaan_controller@produk_reasji');

        // produk reasuransi Syariah
        Route::get('/reassya','Nebros\Profile_perusahaan_controller@produk_reassya');

        // portal
        Route::get('/portal','Nebros\Portal_controller@index');
        Route::get('/portal/{slug}','Nebros\Portal_controller@detail');

        Route::get('portal/banner/{kata}','Nebros\Portal_controller@index_banner');

        // get sub menu
        Route::get('/get-sub-menu/{id}','Nebros\Menu_controller@get_menu');

        // contact us
        Route::get('/contact-us','Nebros\Contact_controller@index');
        Route::post('/contact-us','Nebros\Contact_controller@store');

        // riwayat perusahaan
        Route::get('/riwayat-perusahaan','Nebros\Profile_perusahaan_controller@riwayat_perusahaan');

        // ***************** End Template Nebro *****************

        // ***************** Template Pearo *****************
        Route::get('/nre2','Pearo\Beranda_controller@index');

        // profile perusahaan
        Route::get('/nre2/profile-perusahaan','Pearo\Profile_perusahaan_controller@index');

        // visi misi perusahaan
        Route::get('/nre2/visi-misi','Pearo\Profile_perusahaan_controller@visi_misi');

        // maksud dan tujuan
        Route::get('/nre2/maksud-tujuan','Pearo\Profile_perusahaan_controller@maksud');

        // portal
        Route::get('/nre2/portal','Pearo\Portal_controller@index');
        Route::get('/nre2/portal/{slug}','Pearo\Portal_controller@detail');

        // gallery
        Route::get('gallery/kat/{kategori}','Nebros\Gallery_controller@index');
        Route::get('gallery/{id}','Nebros\Gallery_controller@detail');

        Route::get('gallery-publikasi','Nebros\Gallery_controller@index_gallery');
        Route::get('diklat-publikasi','Nebros\Gallery_controller@index_diklat');
        Route::get('csr-publikasi','Nebros\Gallery_controller@index_csr');

        // manage video
        Route::get('video','Nebros\Video_controller@index');

        // banner detail
        Route::get('banner/{id}','Nebros\Banner_controller@detail');

        // ***************** Publikasi *****************
        Route::get('laporan-tahunan/detail','Nebros\Publikasi_controller@laporan_tahunan_detail');
        Route::get('laporan-tahunan','Nebros\Publikasi_controller@laporan_tahunan');

        Route::get('ikhtisar-keuangan','Nebros\Publikasi_controller@ikhtisar_keuangan');
        Route::get('pedoman-perusahaan','Nebros\Publikasi_controller@pedoman_perusahaan');
        Route::get('rating','Nebros\Publikasi_controller@rating');
        Route::get('penghargaan','Nebros\Publikasi_controller@penghargaan');

        Route::get('pengaduan-pelanggan','Nebros\Publikasi_controller@pengaduan_pelanggan');
        Route::post('pengaduan-pelanggan','Nebros\Publikasi_controller@store_pengaduan_pelanggan');
    });

// });

    // prefix en ***********************************************
    Route::group(['prefix' => 'en','middleware'=>['locale:en','visitor']], function() {
        // App::setLocale('en');
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth:admin', 'checkstatus']], function () {
    ...
    // ikhtisar keuangan
    Route::get('ikhtisar_keuangan','Admin\Ikhtisar_keuangan_controller@index');
    Route::put('ikhtisar_keuangan/{id}','Admin\Ikhtisar_keuangan_controller@update');
  ...
  Route::group(['middleware' => 'checkpermission:Dashboard'], function() {
    ...
    // front banner
    Route::get('/front/banner','Admin\Banner_controller@index');

    Route::get('/front/banner/add','Admin\Banner_controller@add')->name('add-banner');
    Route::post('/front/banner/add','Admin\Banner_controller@store')->name('store-banner');

    Route::get('/front/banner/{id}','Admin\Banner_controller@edit')->name('edit-banner');
    Route::put('/front/banner/{id}','Admin\Banner_controller@update')->name('update-banner');

    Route::delete('/front/banner/{id}','Admin\Banner_controller@delete')->name('hapus-banner');

    Route::get('banner/with-text/{id}','Admin\Banner_controller@with_text');
    Route::get('banner/no-text/{id}','Admin\Banner_controller@no_text');

    Route::get('banner/utama/{id}','Admin\Banner_controller@is_utama');
    Route::get('banner/no-utama/{id}','Admin\Banner_controller@no_utama');

    // front footer logo
    Route::get('/front/footer/logo','Admin\Footer_logo_controller@index');

    Route::get('/front/footer/logo/add','Admin\Footer_logo_controller@add')->name('add-footer-logo');
    Route::post('/front/footer/logo/add','Admin\Footer_logo_controller@store')->name('store-footer-logo');

    Route::delete('footer-logo/{id}','Admin\Footer_logo_controller@delete');

    // m medsos
    Route::get('/front/medsos','Admin\Medsos_controller@index');

    Route::get('/front/medsos/add','Admin\Medsos_controller@add')->name('add-medsos');
    Route::post('/front/medsos/add','Admin\Medsos_controller@store')->name('store-medsos');

    Route::get('/front/medsos/{id}','Admin\Medsos_controller@edit')->name('edit-medsos');
    Route::put('/front/medsos/{id}','Admin\Medsos_controller@update')->name('update-medsos');

    // banner event
    Route::get('banner-event','Admin\Banner_event_controller@index');

    Route::get('banner-event/add','Admin\Banner_event_controller@add');
    Route::post('banner-event/add','Admin\Banner_event_controller@store');

    Route::get('banner-event/{id}','Admin\Banner_event_controller@edit');
    Route::put('banner-event/{id}','Admin\Banner_event_controller@update');

    Route::delete('banner-event/{id}','Admin\Banner_event_controller@delete');

    // manage menu
    Route::get('manage-menu','Admin\Manage_menu_controller@index');

    Route::get('manage-menu/add','Admin\Manage_menu_controller@add');
    Route::post('manage-menu/add','Admin\Manage_menu_controller@store');

    Route::get('manage-menu/{id}','Admin\Manage_menu_controller@edit');
    Route::put('manage-menu/{id}','Admin\Manage_menu_controller@update');

    Route::delete('manage-menu/{id}','Admin\Manage_menu_controller@delete');

    // parent sub menu
    Route::get('parent-sub-menu','Admin\Parent_sub_menu_controller@index');

    Route::get('parent-sub-menu/add','Admin\Parent_sub_menu_controller@add');
    Route::post('parent-sub-menu/add','Admin\Parent_sub_menu_controller@store');

    Route::get('parent-sub-menu/{id}','Admin\Parent_sub_menu_controller@edit');
    Route::put('parent-sub-menu/{id}','Admin\Parent_sub_menu_controller@update');

    Route::delete('parent-sub-menu/{id}','Admin\Parent_sub_menu_controller@delete');

    // parent sub menu
    Route::get('child-sub-menu','Admin\Child_sub_menu_controller@index');

    Route::get('child-sub-menu/add','Admin\Child_sub_menu_controller@add');
    Route::post('child-sub-menu/add','Admin\Child_sub_menu_controller@store');

    Route::get('child-sub-menu/{id}','Admin\Child_sub_menu_controller@edit');
    Route::put('child-sub-menu/{id}','Admin\Child_sub_menu_controller@update');

    Route::delete('child-sub-menu/{id}','Admin\Child_sub_menu_controller@delete');

    // acc blog
    Route::get('blog/acc/{id}','Admin\BlogController@acc');
    Route::get('blog/not-acc/{id}','Admin\BlogController@not_acc');

    // blog featured posts
    Route::get('blog/featured/{id}','Admin\BlogController@featured');
    Route::get('blog/not-featured/{id}','Admin\BlogController@not_featured');

    // blog jadi banner
    Route::get('blog/jadi-banner/{id}','Admin\BlogController@jadi_banner');

    // management alamat ============================================
    Route::get('alamat','Admin\Alamat_controller@index');
    Route::put('alamat','Admin\Alamat_controller@update');

    Route::post('add_no_telp','Admin\Alamat_controller@add_telp');
    Route::delete('add_no_telp/{id}','Admin\Alamat_controller@delete_telp');
    
    Route::post('add_fax','Admin\Alamat_controller@add_fax');
    Route::delete('add_fax/{id}','Admin\Alamat_controller@delete_fax');

    // inbox
    Route::get('inbox','Admin\Inbox_controller@index');
    Route::get('inbox/{id}','Admin\Inbox_controller@details');

    // new gallery
    Route::get('new-gallery','Admin\Gallery_controller@index');
    Route::get('new-gallery/add','Admin\Gallery_controller@add');

    Route::post('new-gallery/add','Admin\Gallery_controller@store');

    Route::get('new-gallery/{id}','Admin\Gallery_controller@edit');
    Route::put('new-gallery/{id}','Admin\Gallery_controller@update');

    Route::delete('new-gallery/{id}','Admin\Gallery_controller@delete');

    // gallery jadi banner
    Route::get('gallery/jadi-banner/{id}','Admin\Gallery_controller@jadi_banner');

    // video management
    Route::get('video','Admin\Video_controller@index');
    Route::get('video/add','Admin\Video_controller@add');
    Route::post('video/add','Admin\Video_controller@store');

    Route::get('video/{id}','Admin\Video_controller@edit');
    Route::put('video/{id}','Admin\Video_controller@update');

    Route::delete('video/{id}','Admin\Video_controller@delete');

    // client management
    Route::get('client','Admin\Client_controller@index');

    Route::get('client/add','Admin\Client_controller@add');
    Route::post('client/add','Admin\Client_controller@store');

    Route::get('client/{id}','Admin\Client_controller@edit');
    Route::put('client/{id}','Admin\Client_controller@update');

    Route::delete('client/{id}','Admin\Client_controller@delete');

    // marquee text
    Route::get('marquee','Admin\Marquee_controller@index');
    Route::post('marquee/{marquee}','Admin\Marquee_controller@store');

    Route::post('marquee/client/add/{marquee}','Admin\Marquee_controller@add_client');

    Route::delete('marquee/client/delete/{id}','Admin\Marquee_controller@delete_client');

    // master color / warna
    Route::get('color','Admin\Color_controller@index');
    Route::put('color','Admin\Color_controller@update');

    // banner pages
    Route::get('banner-page','Admin\Banner_page_controller@index');

    Route::get('banner-page/add','Admin\Banner_page_controller@add');
    Route::post('banner-page/add','Admin\Banner_page_controller@store');

    Route::get('banner-page/{id}','Admin\Banner_page_controller@edit');
    Route::put('banner-page/{id}','Admin\Banner_page_controller@update');

    Route::delete('banner-page/{id}','Admin\Banner_page_controller@delete');

    // manage rating
    // Route::get('rating','Admin\Rating_controller@index');

    Route::get('pengaduan-pelanggan','Admin\Pengaduan_pelanggan_controller@index');
    Route::get('pengaduan-pelanggan/mail/{id}','Admin\Pengaduan_pelanggan_controller@send_maile');

    // master email
    Route::get('email/{email}','Admin\Pengaduan_pelanggan_controller@add_email');
    Route::get('email/set-default/{id}','Admin\Pengaduan_pelanggan_controller@set_default_email');

    // m rating
    Route::get('rating','Admin\Rating_controller@index');

    Route::get('rating/add','Admin\Rating_controller@add');
    Route::post('rating/add','Admin\Rating_controller@store');

    Route::get('rating/{id}','Admin\Rating_controller@edit');
    Route::put('rating/{id}','Admin\Rating_controller@update');

    Route::delete('rating/{id}','Admin\Rating_controller@delete');

    Route::get('rating/jadi-banner/{id}','Admin\Rating_controller@jadi_banner');

    // m penghargaan
    Route::get('penghargaan','Admin\Penghargaan_controller@index');

    Route::get('penghargaan/add','Admin\Penghargaan_controller@add');
    Route::post('penghargaan/add','Admin\Penghargaan_controller@store');

    Route::get('penghargaan/{id}','Admin\Penghargaan_controller@edit');
    Route::put('penghargaan/{id}','Admin\Penghargaan_controller@update');

    Route::delete('penghargaan/{id}','Admin\Penghargaan_controller@delete');

    Route::get('penghargaan/jadi-banner/{id}','Admin\Penghargaan_controller@jadi_banner');

    // laporan tahunan
    Route::get('laporan-tahunan','Admin\Laporan_tahunan_controller@index');
    Route::get('laporan-tahunan/only','Admin\Laporan_tahunan_controller@index_tahunan');

    Route::get('laporan-tahunan/add','Admin\Laporan_tahunan_controller@add');
    Route::post('laporan-tahunan/add','Admin\Laporan_tahunan_controller@store');

    Route::get('laporan-tahunan/{id}','Admin\Laporan_tahunan_controller@edit');
    Route::put('laporan-tahunan/{id}','Admin\Laporan_tahunan_controller@update');

    Route::delete('laporan-tahunan/{id}','Admin\Laporan_tahunan_controller@delete');

    Route::get('laporan-tahunan/jadi-banner/{id}','Admin\Laporan_tahunan_controller@jadi_banner');

    // laporan triwulan
    Route::get('laporan-triwulan','Admin\Laporan_triwulan_controller@index');

    Route::get('laporan-triwulan/add','Admin\Laporan_triwulan_controller@add');
    Route::post('laporan-triwulan/add','Admin\Laporan_triwulan_controller@store');

    Route::delete('laporan-triwulan/{id}','Admin\Laporan_triwulan_controller@delete');

    // pedoman
    Route::get('pedoman','Admin\Pedoman_controller@index');

    Route::get('pedoman/add','Admin\Pedoman_controller@add');
    Route::post('pedoman/add','Admin\Pedoman_controller@store');

    Route::get('pedoman/{id}','Admin\Pedoman_controller@edit');
    Route::put('pedoman/{id}','Admin\Pedoman_controller@update');

    Route::delete('pedoman/{id}','Admin\Pedoman_controller@delete');

    // manage direksi
    Route::get('direksi','Admin\Direksi_controller@index');

    Route::post('direksi/title','Admin\Direksi_controller@update_title');

    Route::get('direksi/add','Admin\Direksi_controller@add');
    Route::post('direksi/add','Admin\Direksi_controller@store');

    Route::get('direksi/{id}','Admin\Direksi_controller@edit');
    Route::put('direksi/{id}','Admin\Direksi_controller@update');

    Route::delete('direksi/{id}','Admin\Direksi_controller@delete');

    // dewan komisaris
    Route::get('dewan-komisaris','Admin\Dewan_komisaris_controller@index');

    Route::post('dewan-komisaris/title','Admin\Dewan_komisaris_controller@update_title');

    Route::get('dewan-komisaris/add','Admin\Dewan_komisaris_controller@add');
    Route::post('dewan-komisaris/add','Admin\Dewan_komisaris_controller@store');

    Route::get('dewan-komisaris/{id}','Admin\Dewan_komisaris_controller@edit');
    Route::put('dewan-komisaris/{id}','Admin\Dewan_komisaris_controller@update');

    Route::delete('dewan-komisaris/{id}','Admin\Dewan_komisaris_controller@delete');

    // dewan pengawas syariah
    Route::get('dewan-syariah','Admin\Dewan_syariah_controller@index');

    Route::post('dewan-syariah/title','Admin\Dewan_syariah_controller@update_title');

    Route::get('dewan-syariah/add','Admin\Dewan_syariah_controller@add');
    Route::post('dewan-syariah/add','Admin\Dewan_syariah_controller@store');

    Route::get('dewan-syariah/{id}','Admin\Dewan_syariah_controller@edit');
    Route::put('dewan-syariah/{id}','Admin\Dewan_syariah_controller@update');

    Route::delete('dewan-syariah/{id}','Admin\Dewan_syariah_controller@delete');

    Route::get('visitor','Admin\Visitor_controller@index');
  ...
  Route::group(['middleware' => 'checkpermission:Blogs'], function() {
    ...
    Route::post('blog/add/blog/add','Admin\BlogController@new_store');
