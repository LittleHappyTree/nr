...
<!-- PORTFOLIO 
================================================== --> 
<section id="portfolio" class="portfolio graybg" style="padding-bottom: 0px;">
    <div class="container wow fadeInUp">
      ...
      <div class="row masonry clearfix">
          ...
          @foreach($td->tahuns($td->tahunnya) as $dt)
          <a href="{{ asset($dt->file) }}" class="col-lg-4 col-sm-6 grid-item application " download="">
            <figure class="portfolio-item">                       
                  <img style="width: 100%;height: 247px;" src="{{asset($dt->photo)}}" alt="" />
              <figcaption>
                  <h3 class="title">{{ Str::limit($dt->nama,50) }}</h3>
                  <span style="font-size: 15px;">{{ date('Y',strtotime($dt->tahun)) }} </span>
              </figcaption> 
            </figure>
          </a>
          @endforeach
...
<section id="portfolio" class="portfolio graybg" style="padding-top: 0px;">
    <div class="container wow fadeInUp">
      <div class="col-lg-12">
        <div class="section-title bottom_15 top_30">
            @if(\App::getLocale() == 'id')
      ...
      <div class="row masonry clearfix">
          ...
          @foreach($td->triwulans($td->tahunnya) as $dt)
          <a href="{{ asset($dt->file) }}" class="col-lg-4 col-sm-6 grid-item application " download="">
            <figure class="portfolio-item">                       
                  <img style="width: 100%;height: 247px;" src="{{asset($dt->photo)}}" alt="" />
              <figcaption>
      ...
      <div class="col-md-12">
        <center>
          <a href="{{ url('laporan-tahunan/detail') }}" class="site-btn top_30 btn-see-more" style="background:#176ab4;">SEE MORE</a>
        </center>
      </div>
