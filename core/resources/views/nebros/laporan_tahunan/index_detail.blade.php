...
<div class="container wow fadeInUp">
  ...
  @foreach($tahun_tahunan->chunk(4) as $thChunk)
  <div class="row">

    @foreach($thChunk as $td)
    <div class="col-md-3">
      <table class="table">
        <thead>
          <tr>
            <th><b><i>{{ $td->tahunnya }}</i></b></th>
          </tr>
        </thead>
        ...
        <tbody>
          ...
          <tr>
            <td>
              <a href="{{ asset($dt->file) }}" target="_blank">{{ $dt->nama }}</a>
            </td>
          </tr>
          @endforeach
        </tbody>
  ...
  <!-- Laporan Triwulan -->
  @foreach($tahun_triwulan->chunk(4) as $thChunk)
  <div class="row">
