...
<section id="portfolio" class="portfolio graybg">
    <div class="container wow fadeInUp">
      ...
      <div class="row masonry clearfix">
          ...
          <a href="{{asset('banners/'.$dt->photo)}}" class="col-lg-4 col-sm-6 grid-item application lightbox-icon">
            <figure class="portfolio-item">                       
                  <img style="width: 100%;height: 247px;" src="{{asset('banners/'.$dt->photo)}}" alt="" />
              <figcaption>
