      ...
      <div class="card">
        <div class="card-header">
          <p>
            ...
            <a class="btn btn-secondary btn-sm" href="{{ route('add-footer-logo') }}">
            <span class="btn-label">
                      ...
                      <tr>
                        <td>
                          <div>
                            ...
                            <button class="btn btn-danger btn-xs btn-hapus" href="{{ url('admin/footer-logo/'.$dt->id) }}">
                            <span class="btn-label">
                        ...
                        <td>{{ $e+1 }}</td>
                        <td>
                          <img style="height: 50px;" src="{{ asset($dt->photo) }}">
                        </td>
                        <td>{{ $dt->link }}</td>
                        <td>{{ $dt->created_at }}</td>
                        <td>{{ $dt->updated_at }}</td>
