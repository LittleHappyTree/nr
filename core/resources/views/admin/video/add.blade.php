          ...
          <div class="row">
            <div class="col-lg-6">
              ...
              @else
                ...
                <form role="form" method="post" action="{{ url('admin/video/add') }}" enctype="multipart/form-data">
                  @csrf
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="judul_en" class="form-control" id="exampleInputEmail1" placeholder="Judul">
                    </div>

                    <div class="form-group">
                      <label for="exampleInputPassword1">url video</label>
                      <input type="text" name="url" autocomplete="off" class="form-control" id="exampleInputPassword1" placeholder="url video">
                    </div>
