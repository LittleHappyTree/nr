      ...
      <div class="card">
        <div class="card-header">
          <p>
            ...
            <a class="btn btn-secondary btn-sm" href="{{ url('admin/dewan-syariah/add') }}">
            <span class="btn-label">
              <i class="fas fa-plus"></i>
            </span>
            Tambah Dewan Syariah
            </a>
        ...
        <div class="card-body">
          ...
          <form class="form-inline" method="post" action="{{ url('admin/dewan-syariah/title') }}">
            @csrf
