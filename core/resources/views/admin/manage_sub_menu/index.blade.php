      ...
      <div class="card">
        <div class="card-header">
          <p>
            ...
            <a class="btn btn-secondary btn-sm" href="{{ url('admin/parent-sub-menu/add') }}">
            <span class="btn-label">
              <i class="fas fa-plus"></i>
            </span>
            Tambah Parent Sub Menu
            </a>
                  ...
                  <table class="table table-striped mt-3">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>
                          <div>
                            <a class="btn btn-warning btn-xs" href="{{ url('admin/parent-sub-menu/'.$dt->id) }}">
                            <span class="btn-label">
