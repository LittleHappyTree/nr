    ...
    <div class="sidebar-content">
      ...
      <ul class="nav nav-primary">
        ...
        @if (empty($admin->role) || (!empty($permissions) && in_array('Dashboard', $permissions)))
          ...
          <li class="nav-item @if(request()->path() == 'admin/dashboard') active @endif">
            <a href="{{route('admin.dashboard')}}">
              <i class="la flaticon-paint-palette" style="color:  #964B00"></i>
              <p>Dashboard</p>
            </a>
          </li>
        @endif
        ...
        @if (empty($admin->role) || (!empty($permissions) && in_array('Basic Settings', $permissions)))
          ...
          @endif">
            <a data-toggle="collapse" href="#front">
              <i class="la flaticon-settings" style="color: #FFD700;"></i>
              <p>Front Settings</p>
              <span class="caret"></span>
            </a>
            <div class="collapse
            ...
            @endif" id="front">
              <ul class="nav nav-collapse">
                <li class="@if(request()->path() == 'admin/front/banner') active @endif">
                  <a href="{{ url('admin/front/banner') }}">
                    <span class="sub-item">Banner</span>
                  </a>
                </li>

                <li class="@if(request()->path() == 'admin/banner-event') active @endif">
                  <a href="{{ url('admin/banner-event') }}">
                    <span class="sub-item">Banner Event</span>
                  </a>
                </li>

                <li class="@if(request()->path() == 'admin/banner-page') active @endif">
                  <a href="{{ url('admin/banner-page') }}">
                    <span class="sub-item">Banner Page</span>
                  </a>
                </li>

                <li class="@if(request()->path() == 'admin/front/footer/logo') active @endif">
                  <a href="{{ url('admin/front/footer/logo') }}">
                    <span class="sub-item">Front Footer Logo</span>
                  </a>
                </li>

                <li class="@if(request()->path() == 'admin/front/medsos') active @endif">
                  <a href="{{ url('admin/front/medsos') }}">
                    <span class="sub-item">Medsos</span>
                  </a>
                </li>

                <li class="@if(request()->path() == 'admin/marquee') active @endif">
                  <a href="{{ url('admin/marquee') }}">
                    <span class="sub-item">Marquee</span>
                  </a>
                </li>

                <li class="@if(request()->path() == 'admin/color') active @endif">
                  <a href="{{ url('admin/color') }}">
                    <span class="sub-item">Manage Color</span>
                  </a>
                </li>

                <li class="@if(request()->path() == 'admin/ikhtisar_keuangan') active @endif">
                  <a href="{{ url('admin/ikhtisar_keuangan') }}">
                    <span class="sub-item">Ikhtisar Keuangan</span>
                  </a>
                </li>
        ...
        <!-- @if (empty($admin->role) || (!empty($permissions) && in_array('Basic Settings', $permissions)))
          ...
          @elseif(request()->path() == 'admin/seo') active
          @endif">
            <a data-toggle="collapse" href="#manage-menu">
            ...
            @elseif(request()->path() == 'admin/script') show
            @elseif(request()->path() == 'admin/seo') show
            @endif" id="manage-menu">
              <ul class="nav nav-collapse">
                <li class="@if(request()->path() == 'admin/manage-menu') active @endif">
                  <a href="{{ url('admin/manage-menu') }}">
                    <span class="sub-item">Manage Menu</span>
                  </a>
                </li>

                <li class="@if(request()->path() == 'admin/parent-sub-menu') active @endif">
                  <a href="{{ url('admin/parent-sub-menu') }}">
                    <span class="sub-item">Parent Sub Menu</span>
                  </a>
                </li>

                <li class="@if(request()->path() == 'admin/child-sub-menu') active @endif">
                  <a href="{{ url('admin/child-sub-menu') }}">
                    <span class="sub-item">Child Sub Menu</span>
                  </a>
                </li>
        ...
        @if (empty($admin->role) || (!empty($permissions) && in_array('Basic Settings', $permissions)))
          ...
          @elseif(request()->path() == 'admin/seo') active
          @endif">
            <a data-toggle="collapse" href="#manage-alamat">
              <i class="fa fa-anchor" style="color:  #00FF00;"></i>
              <p>Management Alamat</p>
              <span class="caret"></span>
            </a>
            <div class="collapse
            @if(request()->path() == 'admin/favicon') show
            ...
            @elseif(request()->path() == 'admin/script') show
            @elseif(request()->path() == 'admin/seo') show
            @endif" id="manage-alamat">
              <ul class="nav nav-collapse">
                <li class="@if(request()->path() == 'admin/alamat') active @endif">
                  <a href="{{ url('admin/alamat') }}">
                    <span class="sub-item">Update Alamat</span>
                  </a>
                </li>
        ...
        @if (empty($admin->role) || (!empty($permissions) && in_array('Basic Settings', $permissions)))
          ...
          @elseif(request()->path() == 'admin/seo') active
          @endif">
            <a data-toggle="collapse" href="#manage-inbox">
              <i class="  fa fa-archive" style="color: #FFFF00;"></i>
              <p>Inbox</p>
              <span class="caret"></span>
            </a>
            <div class="collapse
            ...
            @elseif(request()->path() == 'admin/script') show
            @elseif(request()->path() == 'admin/seo') show
            @endif" id="manage-inbox">
              <ul class="nav nav-collapse">
                <li class="@if(request()->path() == 'admin/inbox') active @endif">
                  <a href="{{ url('admin/inbox') }}">
                    <span class="sub-item">List Inbox</span>
                  </a>
                </li>
        ...
        @if (empty($admin->role) || (!empty($permissions) && in_array('Pages', $permissions)))
          ...
          @endif">
            <a data-toggle="collapse" href="#pages">
              <i class="  fa fa-at" style="color:  #FF00FF;"></i>
              <p>Tentang Kami</p>
              <span class="caret"></span>
            </a>
            <div class="collapse
        ...
        <li class="nav-item
           @if(request()->path() == 'admin/pedoman') active
           @elseif(request()->path() == 'admin/pedoman') active
           @elseif(request()->is('admin/gallery/*/edit')) active
           @endif">
            <a href="{{ url('admin/pedoman') }}">
              <i class="  fa fa-balance-scale" style="color:  #FF007F;"></i>
              <p>Pedoman Perusahaan</p>
            </a>
          </li>

        <li class="nav-item
           @if(request()->path() == 'admin/direksi') active
           @elseif(request()->path() == 'admin/direksi') active
           @elseif(request()->is('admin/gallery/*/edit')) active
           @endif">
            <a href="{{ url('admin/direksi') }}">
              <i class="    fa fa-barcode" style="color: #FF0000;"></i>
              <p>Direksi Management</p>
            </a>
          </li>

          <li class="nav-item
           @if(request()->path() == 'admin/dewan-komisaris') active
           @elseif(request()->path() == 'admin/dewan-komisaris') active
           @elseif(request()->is('admin/gallery/*/edit')) active
           @endif">
            <a href="{{ url('admin/dewan-komisaris') }}">
          ...
          <li class="nav-item
           @if(request()->path() == 'admin/dewan-syariah') active
           @elseif(request()->path() == 'admin/dewan-syariah') active
           @elseif(request()->is('admin/gallery/*/edit')) active
           @endif">
            <a href="{{ url('admin/dewan-syariah') }}">
              <i class="  fa fa-bath" style="color:  #FFC0CB;"></i>
              <p>Dewan Syariah</p>
            </a>
          </li>
        ...
        @if (empty($admin->role) || (!empty($permissions) && in_array('Gallery Management', $permissions)))
          {{-- Gallery Management --}}
          <li class="nav-item
           @if(request()->path() == 'admin/new-gallery') active
           @elseif(request()->path() == 'admin/new-gallery') active
           @elseif(request()->is('admin/gallery/*/edit')) active
           @endif">
            <a href="{{ url('admin/new-gallery') }}">
              <i class="  fa fa-beer" style="color:  #6F00FF;"></i>
        ...
        @if (empty($admin->role) || (!empty($permissions) && in_array('Gallery Management', $permissions)))
          {{-- Gallery Management --}}
          <li class="nav-item
           @if(request()->path() == 'admin/video') active
           @elseif(request()->path() == 'admin/video') active
           @elseif(request()->is('admin/gallery/*/edit')) active
           @endif">
            <a href="{{ url('admin/video') }}">
              <i class="  fa fa-bell" style="color:  #FF7F00;"></i>
          ...
          <li class="nav-item
           ...
           @endif">
            <a href="{{ url('admin/client') }}">
              <i class="  fa fa-bell-slash" style="color:  #00FFFF;"></i>
              <p>Client Management</p>
            </a>
          </li>

          <li class="nav-item
           @if(request()->path() == 'admin/pengaduan-pelanggan') active
           @elseif(request()->path() == 'admin/pengaduan-pelanggan') active
           @elseif(request()->is('admin/gallery/*/edit')) active
           @endif">
            <a href="{{ url('admin/pengaduan-pelanggan') }}">
              <i class="  fa fa-binoculars" style="color:  #BF00FF;"></i>
        ...
        @if (empty($admin->role) || (!empty($permissions) && in_array('Blogs', $permissions)))
          ...
          @endif">
            <a data-toggle="collapse" href="#blog">
              <i class="  fa fa-birthday-cake" style="color:  #8F00FF;"></i>
              <p>Blogs</p>
              <span class="caret"></span>
            </a>
            <div class="collapse
          ...
          <li class="nav-item
           @if(request()->path() == 'admin/rating') active
           @elseif(request()->path() == 'admin/rating') active
           @elseif(request()->is('admin/gallery/*/edit')) active
           @endif">
            <a href="{{ url('admin/rating') }}">
              <i class="  fa fa-bolt" style="color:  #808000;"></i>
              <p>Rating</p>
            </a>
          </li>

          <li class="nav-item
           @if(request()->path() == 'admin/penghargaan') active
           @elseif(request()->path() == 'admin/penghargaan') active
           @elseif(request()->is('admin/gallery/*/edit')) active
           @endif">
            <a href="{{ url('admin/penghargaan') }}">
              <i class="  fa fa-book" style="color:  #FFD700;"></i>
              <p>Penghargaan</p>
            </a>
          </li>

          <li class="nav-item
           @if(request()->path() == 'admin/laporan-tahunan') active
           @elseif(request()->path() == 'admin/laporan-tahunan') active
           @elseif(request()->is('admin/gallery/*/edit')) active
           @endif">
            <a href="{{ url('admin/laporan-tahunan') }}">
              <i class="la flaticon-picture" style="color:  #FF007F;"></i>
              <p>Laporan Tahunan</p>
            </a>
          </li>

          <li class="nav-item
           @if(request()->path() == 'admin/visitor') active
           @elseif(request()->path() == 'admin/visitor') active
           @elseif(request()->is('admin/gallery/*/edit')) active
           @endif">
            <a href="{{ url('admin/visitor') }}">
              <i class="  fa fa-bullhorn" style="color: #00FFFF;"></i>
