      ...
      <div class="card">
        <div class="card-header">
          <p>
            ...
            <a class="btn btn-secondary btn-sm" href="{{ url('admin/banner-page/add') }}">
            <span class="btn-label">
                  ...
                  <table class="table table-striped mt-3">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>
                          <div>
                            <a class="btn btn-warning btn-xs" href="{{ url('admin/banner-page/'.$dt->id) }}">
                            <span class="btn-label">
                              <i class="fas fa-pen"></i>
                            </span>
                            </a>

                            <button class="btn btn-danger btn-xs btn-hapus" href="{{ url('admin/banner-page/'.$dt->id) }}">
                            <span class="btn-label">
                        ...
                        <td>
                          <img src="{{ asset('banner_page/'.$dt->photo) }}" style="width: 200px;">
                        </td>
