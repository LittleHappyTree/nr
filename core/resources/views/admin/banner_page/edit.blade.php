      ...
      <div class="card">
        <div class="card-header">
          <p>
            ...
            <a class="btn btn-secondary btn-sm btn-flat" href="{{ url('admin/banner-page') }}">
            <span class="btn-label">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
              ...
              @else
                <form role="form" method="post" action="{{ url('admin/banner-page/'.$dt->id) }}" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  {{ method_field('PUT') }}
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="url" class="form-control" id="exampleInputEmail1" placeholder="url" value="{{ $dt->url }}">
                </div>
