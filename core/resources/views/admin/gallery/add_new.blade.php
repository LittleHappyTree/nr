      ...
      <div class="col-md-8">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form role="form" method="post" action="{{ url('admin/new-gallery/add') }}" enctype="multipart/form-data">
              @csrf
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="judul_en"></input>
                </div>

                <div class="form-group">
                  <label for="exampleInputEmail1">Keterangan</label>
                  <textarea class="form-control nic-edit" rows="5" name="keterangan"></textarea>
                </div>

                <div class="form-group">
                  <label for="exampleInputEmail1">Keterangan EN</label>
                  <textarea class="form-control nic-edit" rows="5" name="keterangan_en"></textarea>
                </div>
                ...
                <div class="form-group">
                  ...
                  <p class="help-block">Upload Multiple Photo.</p>
                </div>

                <div class="form-group">
                  <label for="exampleInputEmail1">Compress (Persentase)</label>
                ...
                <div class="form-group">
                  ...
                  <textarea rows="5" class="form-control" name="meta_description"></textarea>
                </div>
