            ...
            <div class="col-lg-12">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" name="nama_kecil" class="form-control" id="exampleInputEmail1" placeholder="Caption Kecil">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Caption Besar</label>
                  <input type="text" name="nama_besar" class="form-control" id="exampleInputPassword1" placeholder="Caption Besar">
                </div>

                <div class="form-group">
                  <label for="exampleInputPassword1">urutan</label>
                  <input type="text" name="urutan" class="form-control" id="exampleInputPassword1" placeholder="urutan">
                </div>

                <div class="form-group">
                  <label for="exampleInputPassword1">periode dari</label>
                  <input type="text" name="dari" class="form-control datepicker" id="exampleInputPassword1" placeholder="periode dari" autocomplete="off" value="{{ date('m/d/Y') }}">
                </div>

                <div class="form-group">
                  <label for="exampleInputPassword1">periode sampai</label>
                  <input type="text" name="sampai" class="form-control datepicker" id="exampleInputPassword1" placeholder="periode sampai" autocomplete="off" value="{{ date('m/d/Y',strtotime('+7 days')) }}">
                </div>
