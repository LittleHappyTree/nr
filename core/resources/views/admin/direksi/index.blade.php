      ...
      <div class="card">
        <div class="card-header">
          <p>
            ...
            <a class="btn btn-secondary btn-sm" href="{{ url('admin/direksi/add') }}">
            <span class="btn-label">
        ...
        <div class="card-body">
          ...
          <form class="form-inline" method="post" action="{{ url('admin/direksi/title') }}">
            @csrf
                  ...
                  <table class="table table-striped mt-3">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <div>
                            <a class="btn btn-warning btn-xs" href="{{ url('admin/direksi/'.$dt->id) }}">
                            <span class="btn-label">
                              <i class="fas fa-pen"></i>
                            </span>
                            </a>

                            <button class="btn btn-danger btn-xs btn-hapus" href="{{ url('admin/direksi/'.$dt->id) }}">
                            <span class="btn-label">
